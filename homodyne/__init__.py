...
try:
    ...
    import logging
    logging.getLogger(__name__).warning(f"ClassicalOptimizer not available: {e}")
...
try:
    ...
    import logging
    logging.getLogger(__name__).warning(f"BayesianOptimizer not available: {e}")
...
try:
    ...
    import logging
    logging.getLogger(__name__).warning(f"MCMC functionality not available: {e}")
