...
class TestConfigurationIntegration:
    ...
    def test_core_analysis_uses_config_manager_ranges(self, temp_directory, config_with_custom_angle_filtering):
        ...
        with patch('homodyne.analysis.core.HomodyneAnalysisCore') as MockCore:
            ...
            test_angles = np.array([-20.0, -10.0, 0.0, 10.0, 20.0, 160.0, 170.0, 180.0, 190.0, 200.0])
            ...
            expected_indices = [1, 2, 3, 6, 7, 8]  # Angles in [-15, 15] and [165, 195]
            assert optimization_indices == expected_indices
    
    def test_core_analysis_respects_disabled_filtering(self, temp_directory, config_with_disabled_angle_filtering):
        ...
        config_with_no_matches = {
            ...
            "optimization_config": {
                "angle_filtering": {
                    "enabled": True,
                    "target_ranges": [
                        {"min_angle": 300.0, "max_angle": 350.0}  # No angles will match
                    ],
                    "fallback_to_all_angles": True
                }
            }
    ...
    def test_optimization_methods_integration(self, temp_directory, config_with_custom_angle_filtering):
    ...
    def test_real_config_files_integration(self):
        ...
        if my_config_path.exists():
            ...
            expected_keys = {"enabled", "target_ranges", "fallback_to_all_angles"}
