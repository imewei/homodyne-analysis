...
class MockAnalysisCorePerformance:
    ...
    def calculate_chi_squared_optimized(self, params, phi_angles, c2_experimental, **kwargs):
        """Optimized chi-squared calculation with support for additional parameters."""
