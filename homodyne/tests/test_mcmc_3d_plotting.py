    ...
    def test_mcmc_3d_plotting_without_trace_data(self, mock_plot_3d):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            try:
                ...
                print("✓ plot_3d_surface called with posterior_samples=None in fallback mode")
...
class TestMCMCPosteriorSampleProcessing:
    ...
    def test_confidence_interval_calculation(self):
        ...
        print(f"✓ Confidence interval calculation: {within_ci_ratio:.1%} of mean points within CI")
