...
class TestConfigManagerAngleFiltering:
    ...
    def test_angle_filtering_enabled_with_config(self, temp_directory, config_with_angle_filtering):
    ...
    def test_angle_filtering_enabled_without_config(self, temp_directory, config_without_angle_filtering):
    ...
    def test_angle_filtering_enabled_custom(self, temp_directory, config_with_custom_angle_filtering):
    ...
    def test_get_target_angle_ranges_default(self, temp_directory, config_with_angle_filtering):
    ...
    def test_get_target_angle_ranges_missing_config(self, temp_directory, config_without_angle_filtering):
    ...
    def test_get_target_angle_ranges_custom(self, temp_directory, config_with_custom_angle_filtering):
    ...
    def test_should_fallback_to_all_angles_default(self, temp_directory, config_with_angle_filtering):
    ...
    def test_should_fallback_to_all_angles_custom(self, temp_directory, config_with_custom_angle_filtering):
    ...
    def test_get_angle_filtering_config_complete(self, temp_directory, config_with_angle_filtering):
    ...
    def test_get_angle_filtering_config_defaults(self, temp_directory, config_without_angle_filtering):
            ...
            "optimization_config": {
                "angle_filtering": {
                    ...
                    "target_ranges": [
                        ...
                        {"min_angle": 175.0, "max_angle": 185.0}  # Valid range
                    ],
                    "fallback_to_all_angles": True
                }
            }
