...
class TestMCMCConfigurationReading:
    ...
    def test_mcmc_config_reading_correct_path(self):
        ...
        mcmc_config = test_config.get("optimization_config", {}).get(
            "mcmc_sampling", {}
        )
    ...
    def test_real_config_file_structure(self):
        ...
        mcmc_config = realistic_config.get("optimization_config", {}).get(
            "mcmc_sampling", {}
        )
    ...
    def test_mcmc_parameter_bounds_usage(self):
        ...
        test_config = {
            "optimization_config": {
                "mcmc_sampling": {"enabled": True, "draws": 1000, "chains": 2}
            },
            "initial_parameters": {
                "parameter_names": ["D0", "alpha", "D_offset"],
