...
class TestClassicalOptimizationConfigurationReading:
    ...
    def test_initial_parameters_reading(self):
        ...
        actual_values = np.array(test_config["initial_parameters"]["values"], dtype=np.float64)
        ...
        test_config = {
            "parameter_space": {
                "bounds": [
                    ...
                    {"name": "gamma_dot_t_offset", "min": 0.0, "max": 0.01, "type": "uniform"},
    ...
    def test_static_mode_parameter_selection(self):
        ...
        initial_parameters = np.array(test_config["initial_parameters"]["values"], dtype=np.float64)
    ...
    def test_real_config_structure_compatibility(self):
        ...
        initial_params = np.array(realistic_config["initial_parameters"]["values"], dtype=np.float64)
