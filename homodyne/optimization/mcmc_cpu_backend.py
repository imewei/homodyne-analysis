...
os.environ["PYTENSOR_FLAGS"] = (
    "device=cpu,floatX=float32,mode=FAST_RUN,optimizer=fast_run"
)
os.environ["PYTENSOR_COMPILEDIR_FORMAT"] = (
    "compiledir_%(platform)s-%(processor)s-%(python_version)s-%(python_bitwidth)s--cpu-only"
)
